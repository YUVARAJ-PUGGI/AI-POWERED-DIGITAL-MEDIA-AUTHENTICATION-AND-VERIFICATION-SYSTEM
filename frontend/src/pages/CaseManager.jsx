...
const mockCases = [
  { id: 'CR-2026-089', title: 'Downtown Bank Heist', status: 'open', officers: 3, evidenceCount: 12, date: '2026-03-22' },
  { id: 'CR-2026-102', title: 'Cyber Fraud Syndicate', status: 'under_review', officers: 5, evidenceCount: 45, date: '2026-03-24' },
  { id: 'CR-2026-133', title: 'Alleyway Altercation', status: 'closed', officers: 2, evidenceCount: 4, date: '2026-03-15' },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-2xl font-bold">Case Directory</h2>
          <p className="text-slate-400">Manage case files and attached digital evidence</p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-dark-700 text-slate-400 text-sm">
                ...
                <th className="pb-3 font-medium">Evidence Files</th>
            ...
            <tbody className="text-sm">
              {mockCases.map((c) => (
                <tr key={c.id} className="border-b border-dark-700/50 hover:bg-dark-800/50 transition-colors group">
                  ...
                  <td className="py-4 text-slate-400">{c.officers} Officers</td>
